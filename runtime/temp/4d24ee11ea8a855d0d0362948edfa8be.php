...
<form id="edit-form" class="form-horizontal form-ajax" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" name="row[imagewidth]" value="<?php echo htmlentities($row['imagewidth'] ?? ''); ?>"  id="c-imagewidth" class="form-control" required />
        </div>
    </div>
    <div class="form-group">
        <label for="c-imageheight" class="control-label col-xs-12 col-sm-2"><?php echo __('Imageheight'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input type="text" name="row[imageheight]" value="<?php echo htmlentities($row['imageheight'] ?? ''); ?>"  id="c-imageheight" class="form-control" required />
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="number" name="row[imageframes]" value="<?php echo htmlentities($row['imageframes'] ?? ''); ?>"  id="c-imageframes" class="form-control" />
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="number" name="row[filesize]" value="<?php echo htmlentities($row['filesize'] ?? ''); ?>"  id="c-filesize" class="form-control" />
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" name="row[storage]" value="<?php echo htmlentities($row['storage'] ?? ''); ?>"  id="c-storage" class="form-control" />
        </div>
    </div>
