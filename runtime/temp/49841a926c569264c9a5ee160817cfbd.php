<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:80:"/www/wwwroot/admin.seven78.top/public/../application/admin/view/index/index.html";i:1725591948;s:70:"/www/wwwroot/admin.seven78.top/application/admin/view/common/meta.html";i:1725591948;s:72:"/www/wwwroot/admin.seven78.top/application/admin/view/common/header.html";i:1725591948;s:70:"/www/wwwroot/admin.seven78.top/application/admin/view/common/menu.html";i:1725591948;s:73:"/www/wwwroot/admin.seven78.top/application/admin/view/common/control.html";i:1725591948;s:72:"/www/wwwroot/admin.seven78.top/application/admin/view/common/script.html";i:1725591948;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- 加载样式及META信息 -->
        ...
        <?php echo $menulist; ?>
            ...
            <div class="content-wrapper tab-content tab-addtabs">
                ...
                <div role="tabpanel" class="tab-pane <?php echo $referermenu?'':'active'; ?>" id="con_<?php echo $fixedmenu['id']; ?>">
                    <iframe src="<?php echo $fixedmenu['url']; ?><?php echo stripos($fixedmenu['url'], '?') !== false ? '&' : '?'; ?>addtabs=1" width="100%" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling-x="no" scrolling-y="auto" allowtransparency="yes"></iframe>
                </div>
                <?php endif; if($referermenu): ?>
                <div role="tabpanel" class="tab-pane active" id="con_<?php echo $referermenu['id']; ?>">
                    <iframe src="<?php echo $referermenu['url']; ?><?php echo stripos($referermenu['url'], '?') !== false ? '&' : '?'; ?>addtabs=1" width="100%" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling-x="no" scrolling-y="auto" allowtransparency="yes"></iframe>
                </div>
                <?php endif; ?>
            </div>
