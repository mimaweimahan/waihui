<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/www/wwwroot/admin.seven78.top/public/../application/index/view/user/login.html";i:1725591948;s:73:"/www/wwwroot/admin.seven78.top/application/index/view/layout/default.html";i:1725591948;s:70:"/www/wwwroot/admin.seven78.top/application/index/view/common/meta.html";i:1725591948;s:72:"/www/wwwroot/admin.seven78.top/application/index/view/common/script.html";i:1725591948;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="login-main">
            <form name="form" id="login-form" class="form-vertical" method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <a href="<?php echo url('user/register'); ?>?url=<?php echo htmlentities(urlencode($url ?? '') ?? ''); ?>" class="btn btn-default btn-lg btn-block mt-3 no-border"><?php echo __("Don't have an account? Sign up"); ?></a>
                </div>
                <!--@IndexLoginFormEnd-->
            </form>
        </div>
