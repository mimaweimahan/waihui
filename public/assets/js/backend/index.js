        ...
        index: function () {
            ...
            var playSound = function (str)
            {
                ...
                if ( borswer.indexOf( "ie" ) >= 0 )
                {
                    ...
                    if (str == 'down') {
                        //IE内核浏览器
                        var strEmbed = '<embed name="downembedPlay" id="downPlayer" src="/assets/mp3/down.mp3" autostart="true" hidden="true" loop="false"></embed>';
                    ...
                    if (str == 'down') {
                        var strAudio = "<audio id='downPlay' src='/assets/mp3/"+str+".mp3' hidden='true'>";
                    ...
                    if (str == 'order') {
                        var strAudio = "<audio id='orderPlay' src='/assets/mp3/"+str+".mp3' hidden='true'>";
            ...
            var start = function () {
                getPreTime();
                getCurTime();
                $.post('index/getNotice', {time: preTimestamp}, function (data) {

                    var up = data.recharge;
                    var down = data.withdraw;
                    if (up > 0) {
                        playSound('up');
                    }
                    if (down > 0) {
